...
{
    public class PersonelGetirKkdViewComponent : ViewComponent
    {
        ...
        public PersonelGetirKkdViewComponent(IPersonel_BilgiService personelBilgiService, ITali_BirimService taliBirimService)
        {
