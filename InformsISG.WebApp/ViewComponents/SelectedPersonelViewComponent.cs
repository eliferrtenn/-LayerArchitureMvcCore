...
{
    public class SelectedPersonelViewComponent : ViewComponent
    {
        ...
        public SelectedPersonelViewComponent(IPersonel_BilgiService personelBilgiService, ITali_BirimService taliBirimService)
        {
