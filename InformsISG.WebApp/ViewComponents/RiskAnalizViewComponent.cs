...
{
    public class RiskAnalizViewComponent : ViewComponent
    {
        ...
        public RiskAnalizViewComponent(IRisk_AnalizService riskAnalizService,IBirimService birimService, ITali_BirimService taliBirimService, IRisk_YontemService riskYontemService, IPersonel_BilgiService personelBilgiService)
        {
